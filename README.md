...
|---|---|---|---|---|
| **Splunk SIEM** | Log collection, indexing, correlation, search | 8–16+ cores (scales with log volume) | 32–64 GB | Fast NVMe/SSD, RAID10 — (scales with log volume) | 
| **FortiGate Firewall** | Perimeter security, traffic inspection | 2–4 cores | 4–8 GB | Minimal |
| **Trend Micro EDR (Management Console)** | Aggregates agent alerts/status from all endpoints | 4–8 cores | 16–32 GB | Needs a SQL database backend (add ~50–100 GB for DB growth) |
| **Windows Server + Active Directory** | Identity, authentication, group policy | 2–4 cores | 8–16 GB | 100–200 GB |
